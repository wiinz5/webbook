<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="ThuVien.aspx.cs" Inherits="Web_Programming.ThuVien1" %>
            ...
            <ItemTemplate>
                <ul>
                    <li class="href">
                        ...
                        <div class="right">
                            <a href ="ChiTietTP.aspx?malv=<%# Eval("MaLV") %>&matp=<%# Eval("MaTP") %>"><%# Eval("TenTP") %></a>
